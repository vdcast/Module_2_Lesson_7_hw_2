...
class OnBoardStartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_on_board_start, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btStart.setOnClickListener {
            activity?.vpOnBoarding?.visibility = View.GONE
            activity?.clMain?.visibility = View.VISIBLE
        }
